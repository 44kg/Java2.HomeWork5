...
¬торой разбивает массив на два массива, в двух потоках высчитывает новые значени€ и потом склеивает эти массивы обратно в один.
...
ѕримечание:
System.arraycopy() Ц копирует данные из одного массива в другой:
System.arraycopy(массив-источник, откуда начинаем брать данные из массива-источника, массив-назначение, откуда начинаем записывать данные в массив-назначение, сколько €чеек копируем)
ѕо замерам времени:
...
ƒл€ второго метода замер€ете врем€ разбивки массива на 2, просчета каждого из двух массивов и склейки.